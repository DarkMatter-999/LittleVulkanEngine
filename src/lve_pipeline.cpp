...
namespace lve {
LvePipeline::LvePipeline(LveDevice& device, const std::string& vertFilePath, const std::string& fragFilePath, const PipeLineConfigInfo& config) : lveDevice{device} {
...
LvePipeline::~LvePipeline() {
	...
	void LvePipeline::createGraphicsPipeline(const std::string& vertFilepath, const std::string& fragFilepath, const PipeLineConfigInfo& config) {
		auto vertCode = readFile(vertFilepath);
		auto fragCode = readFile(fragFilepath);

		assert(config.pipelineLayout != VK_NULL_HANDLE && "Cannot create graphics pipeline no pipeline layout provided in config");
